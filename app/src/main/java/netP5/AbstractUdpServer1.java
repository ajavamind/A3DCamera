...
public abstract class AbstractUdpServer1 implements Runnable {
    ...
    public void start() {
        ...
        try {
            this._myDatagramSocket = new DatagramSocket(null);
            this._myDatagramSocket.setReuseAddress(true);
            this._myDatagramSocket.bind(new InetSocketAddress(this._myPort));
            ...
            Logger.printError("UdpServer.start()", " IOException, could not create new DatagramSocket @ port " + this._myPort + " " + var2);
        }
