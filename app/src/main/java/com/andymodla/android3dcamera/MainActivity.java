...
//    static final int PB_IMAGE_TOGGLE_KEY = KeyEvent.KEYCODE_VOLUME_DOWN;  // Toggle through photo views: SBS, Anaglyph, Left Eye, Right Eye
    ...
    static final int SHUTTER_KEY = KeyEvent.KEYCODE_BUTTON_R1; // 103
    public static final int MODE_KEY = KeyEvent.KEYCODE_BUTTON_R2; // 105
    static final int ANAGLYPH_KEY = KeyEvent.KEYCODE_BUTTON_L2; // 104
    static final int SETTINGS_KEY = KeyEvent.KEYCODE_BUTTON_L1; // 102
    ...
    // soft keys
    public static final int PRINT_KEY = 1000; //KeyEvent.KEYCODE_BUTTON_SELECT; // 109-82 "-" KeyEvent.KEYCODE_MENU;
