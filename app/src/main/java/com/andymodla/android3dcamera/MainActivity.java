...
public class MainActivity extends AppCompatActivity {
    ...
    static final int ANAGLYPH_KEY = KeyEvent.KEYCODE_BUTTON_L2;
    static final int MODE_KEY = KeyEvent.KEYCODE_BUTTON_R2;
    ...
    static final int EV_KEY = KeyEvent.KEYCODE_BUTTON_START; // 108 "+" button
    //static final int EV_KEY = KeyEvent.KEYCODE_BUTTON_X; //  99 down KeyEvent.KEYCODE_DEL = 67 up
