...
class StereoMenuBar extends HorzMenuBar implements IGui {
    PApplet base;

    StereoMenuKey settingsKey;
    StereoMenuKey imageModeKey;
    StereoMenuKey functionKey;
    StereoMenuKey backKey;
    StereoMenuKey optionsKey;
    StereoMenuKey reviewKey;
    StereoMenuKey shutterKey;

    StereoMenuKey minusKey;
    StereoMenuKey downArrowKey;
    StereoMenuKey leftArrowKey;
    StereoMenuKey okKey;
    StereoMenuKey rightArrowKey;
    StereoMenuKey upArrowKey;
    StereoMenuKey plusKey;

    StereoMenuKey gridKey;
    StereoMenuKey[] menuKey;
    ...
    public StereoMenuBar() {
    }

    public StereoMenuBar(PApplet abase, float x, float y, float menuWidth, float menuHeight) {
        this.base = abase;
        ...
        // top menu bar
        reviewKey = new StereoMenuKey(base, MainActivity.MODE_KEY, "REVIEW", menuTextSize, yellow, backTransparent);
        settingsKey = new StereoMenuKey(base, MainActivity.SETTINGS_KEY, "\u2699", LARGE_FONT_SIZE, yellow, backTransparent);
        optionsKey = new StereoMenuKey(base, MainActivity.BUTTON_Y_KEY, "", menuTextSize, graytransparent, backTransparent);
        functionKey = new StereoMenuKey(base, MainActivity.BUTTON_X_KEY, "PARALLAX\nX", menuTextSize, yellow, backTransparent);
        backKey = new StereoMenuKey(base, MainActivity.BUTTON_A_KEY, "BACK\nA", menuTextSize, yellow, backTransparent);
        imageModeKey = new StereoMenuKey(base, MainActivity.ANAGLYPH_KEY, "ANAGLYPH", menuTextSize, yellow, backTransparent);
        shutterKey = new StereoMenuKey(base, MainActivity.SHUTTER_KEY, "\u25C9", GIANT_FONT_SIZE, yellow, backTransparent);

        // bottom menu bar
        downArrowKey = new StereoMenuKey(base, KeyEvent.KEYCODE_DPAD_DOWN, "", menuTextSize, yellow, backTransparent);
        leftArrowKey = new StereoMenuKey(base, KeyEvent.KEYCODE_DPAD_LEFT, "", menuTextSize, yellow, backTransparent);
        minusKey = new StereoMenuKey(base, KeyEvent.KEYCODE_MINUS, "-EV", menuTextSize, yellow, backTransparent);
        okKey = new StereoMenuKey(base, MainActivity.BUTTON_B_KEY, "UNLOCK\nEV", menuTextSize, yellow, backTransparent);
        plusKey = new StereoMenuKey(base, KeyEvent.KEYCODE_PLUS,  "+EV", menuTextSize, yellow, backTransparent);
        rightArrowKey = new StereoMenuKey(base, KeyEvent.KEYCODE_DPAD_RIGHT, "" , menuTextSize, yellow, backTransparent);
        upArrowKey = new StereoMenuKey(base, KeyEvent.KEYCODE_DPAD_UP, "", menuTextSize, yellow, backTransparent);

        menuKey = new StereoMenuKey[numKeys];
        //gridKey = new StereoMenuKey(base, KeyEvent.KEYCODE_G, "Grid", menuTextSize, yellow, backTransparent);
